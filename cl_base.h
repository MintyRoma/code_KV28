...
public:
	...
	void create_link(SIGNAL_POINTER p_signal, HANDLER_POINTER p_handler, cl_base* target);
	void remove_link(SIGNAL_POINTER p_signal, HANDLER_POINTER p_handler, cl_base* target);
